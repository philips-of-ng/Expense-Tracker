...
const MainAppPage = () => {
  ...
  const { uploadNewExpense, uploading } = useAppContext();
      ...
      {tab === "home" ? (
                ...
                <>
                  {todayTransactions.map((transaction, index) => (
                    <>
                      <div
                        key={index}
                        className="one-trans flex justify-between align-middle py-3.5"
                      >
                        <div className="flex align-middle justify-start gap-2.5 min-w-0">
                          <div className="min-w-14 min-h-14 bg-appPurpleLight  rounded-full flex justify-center align-middle">
                            <button>
                              <i
                                class={`${transaction.icon} text-appPurple text-2xl`}
                              ></i>
                            </button>
                          </div>
                        ...
                        <div className="flex align-middle">
                          <span className="text-xl flex align-middle">
        ...
        <div className="grow p-2 pb-20">
          ...
          <div className="flex w-full justify-between bg-white align-middle py-2 sticky top-0 left-0 right-0">
            ...
            <h3 className="text-appPurple text-center text-xl font-bold">
              Receipts
            </h3>
          ...
          <div className="border-2 border-green-500">
            {filtered.length > 0
              ? filtered.map((transaction, index) => (
                  <div
                    key={index}
                    className="one-receipt flex justify-between my-2"
                  >
                    <div className="flex justify-start align-middle gap-2 min-w-0">
                      <div className="min-h-20 min-w-20 border-2 border-blue-600"></div>

                      <div className="min-w-0">
                        <p className="text-lg font-semibold text-gray-600">
                          {transaction.title}
                        </p>
                        <p className="text-appPurple font-bold">
        ...
        <div className="grow p-2 pb-20">
          ...
          <div className="flex w-full justify-between bg-white align-middle py-2 sticky top-0 left-0 right-0">
            ...
            <h3 className="text-appPurple text-center text-xl font-bold">
              New {`${expOrInc == "exp" ? "Expense" : "Income"}`}
            </h3>
          ...
          <div className="my-5 w-5/6 mx-auto flex justify-between align-middle h-10 rounded-3xl bg-gray-300">
            <button
              ...
              className={`${
                expOrInc == "exp" ? "bg-appPurple text-white" : ""
              } flex-1 font-bold rounded-tl-3xl rounded-bl-3xl`}
            >
              Expense
            </button>
            ...
            <button
              ...
              className={`${
                expOrInc == "inc" ? "bg-appPurple text-white" : ""
              } flex-1 font-bold rounded-br-3xl rounded-tr-3xl`}
            >
              Income
            </button>
          </div>
          ...
          <div className="border-2 border-green-500">
            {expOrInc == "exp" ? (
              <form>
                ...
                <p className="my-3 font-bold text-gray-500">
                ...
                <div className="flex justify-between align-middle gap-3">
                  <div className="flex justify-center align-middle h-30 flex-1 border-2 border-appPurple">
                    {expenseInfo.image1 ? (
                      <img
                        ...
                        src={URL.createObjectURL(expenseInfo.image1)}
                        alt=""
                      />
                    ) : (
                      <>
                        <button
                          onClick={() => image1_ref.current.click()}
                          type="button"
                        >
                  ...
                  <div className="flex justify-center align-middle h-30 flex-1 border-2 border-appPurple">
                    {expenseInfo.image2 ? (
                      <img
                        className="w-full object-center"
                        src={URL.createObjectURL(expenseInfo.image2)}
                        alt=""
                      />
                    ) : (
                      <>
                        <button
                          onClick={() => image2_ref.current.click()}
                          type="button"
                        >
                          <i className="bxr  bx-plus"></i>
                        </button>
                ...
                <div className="flex justify-between align-middle gap-3 my-5">
                  <button
                    onClick={() => setTab("home")}
                    className="text-lg font-semibold text-white bg-appPurple flex-1 p-1 rounded-3xl"
                  >
                    Cancel
                  </button>
                  ...
                  <button
                    ...
                    disabled={uploading}
                    onClick={() => {
                      // Manually add type: 'expense' here
                      uploadNewExpense({ ...expenseInfo, type: "expense" });
                    }}
                    className="text-lg font-semibold text-white bg-appPurple flex-1 p-1 rounded-3xl"
                  >
                    Save
              ...
              <form>
                ...
                <div className="flex justify-between align-middle gap-3">
                  <div className="flex justify-center align-middle h-30 flex-1 border-2 border-appPurple">
                    {incomeInfo.image1 ? (
                      ...
                      <>
                        <button
                          onClick={() => image1_inc_ref.current.click()}
                          type="button"
                        >
                          <i className="bxr bx-plus"></i>
                        </button>
                  ...
                  <div className="flex justify-center align-middle h-30 flex-1 border-2 border-appPurple">
                    {incomeInfo.image2 ? (
                      ...
                      <>
                        <button
                          onClick={() => image2_inc_ref.current.click()}
                          type="button"
                        >
                          <i className="bxr bx-plus"></i>
                        </button>
                ...
                <div className="flex justify-between align-middle gap-3 my-5">
                  ...
                  <button
                    type="button" // Make sure this is type='button' so it doesn't refresh the page
                    disabled={uploading}
                    onClick={() => {
                      // Manually add type: 'income' here
                      uploadNewExpense({ ...incomeInfo, type: "income" });
                    }}
                    className="text-lg font-semibold text-white bg-appPurple flex-1 p-1 rounded-3xl"
                  >
        ...
        <div className="w-full p-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white shadow rounded-2xl p-4 text-center border border-[--color-appPurpleLight]">
              ...
              <h2 className="text-2xl font-bold text-[--color-appPurple]">
                $530
              </h2>
            </div>
          ...
          <div className="bg-[--color-appPurple] text-white p-5 rounded-2xl shadow">
            ...
            <p className="text-sm text-[--color-appPurpleLight]">
              You spent{" "}
              <span className="font-semibold text-white">25% more</span> this
              week than last week. Try reducing transport and food expenses.
            </p>
          </div>
        </div>
      ) : (
